...
import { WEEKLY_CLOSE_LOCK_HELPER } from "../lib/time-module-copy";
import {
  blockerReviewHref,
  blockerTypeLabel,
      ...
      {showCloseConfirm ? (
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Closing freezes approved clock time for payroll and billing. You must reopen the week before making
