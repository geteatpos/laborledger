...
import { WORK_ORDERS_RECEPTION_HELPER } from "../lib/operations-module-copy";
...
import { isLocationUsableByClient } from "../lib/location-utils";
  ...
  return (
    <>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <p className="max-w-2xl text-sm text-slate-600">{WORK_ORDERS_RECEPTION_HELPER}</p>
        <Link
          href={receptionRoute()}
          className="inline-flex shrink-0 rounded-lg bg-brand-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-brand-700"
        >
          Receive vehicle
        </Link>
      </div>
