...
export function ArchiveEmployeeButton({
  ...
  const confirmBody = isArchived
    ? `${fullName} will be able to use Field access again after you set a new PIN.`
    : `${fullName} will lose Field access and will no longer appear in active lists. You can reactivate later.`;
