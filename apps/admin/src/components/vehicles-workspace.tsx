...
import {
  VEHICLES_ADD_CTA,
  VEHICLES_RECEIVE_CTA,
  VEHICLES_RECEPTION_HELPER
} from "../lib/operations-module-copy";
import { receptionRoute } from "../lib/reception-utils";
import {
  formatVehicleDate,
  formatVehicleTitle,
...
export function VehiclesWorkspace({
  ...
  return (
    <>
      <EmployeesModuleIntro help={VEHICLES_RECEPTION_HELPER}>
        Review saved vehicles, customer ownership, and intake history. Use this directory to look up records —
        not for daily vehicle intake.
          ...
          {initialServiceClientId ? (
            <div>
              ...
              <div className="mt-1.5 flex flex-wrap gap-2">
                ...
                {activeLocations
                  .filter((location) => isLocationUsableByClient(location, initialServiceClientId))
                  .map((location) => {
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <ArchiveVehicleButton
                            ...
                            vehicleLabel={formatVehicleTitle(vehicle)}
                            isArchived={Boolean(vehicle.archivedAt)}
                            compact
                          />
                        </div>
                      </td>
