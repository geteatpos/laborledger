...
import {
  APPROVALS_MODULE_DESCRIPTION,
  APPROVALS_MODULE_TITLE
...
export default async function ReviewPage({ searchParams }: ReviewPageProps) {
  try {
    ...
    if (workspace.blocked) {
      return (
        <AdminShell title={APPROVALS_MODULE_TITLE} description={APPROVALS_MODULE_DESCRIPTION}>
          <TimeSectionNav />
    ...
    return (
      <AdminShell
        title={APPROVALS_MODULE_TITLE}
        description={APPROVALS_MODULE_DESCRIPTION}
        actions={
