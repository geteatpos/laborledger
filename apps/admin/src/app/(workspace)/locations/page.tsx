...
export default async function LocationsPage({ searchParams }: LocationsPageProps) {
  try {
    ...
    if (workspace.blocked) {
      return (
        <AdminShell title="Locations" description={EMPLOYEES_MODULE_DESCRIPTION}>
          <EmployeesSectionNav />
    ...
    return (
      <AdminShell title="Locations" description={EMPLOYEES_MODULE_DESCRIPTION}>
        <EmployeesSectionNav />
        <EmployeesModuleIntro>{LOCATIONS_MODULE_DESCRIPTION}</EmployeesModuleIntro>
        <LocationsWorkspace
          companies={companies}
