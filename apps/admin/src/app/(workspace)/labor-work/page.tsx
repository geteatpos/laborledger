...
import {
  LABOR_WORK_LOG_MODULE_DESCRIPTION,
  LABOR_WORK_LOG_MODULE_TITLE
...
export default async function LaborWorkPage({ searchParams }: LaborWorkPageProps) {
  try {
    ...
    if (workspace.blocked) {
      return (
        <AdminShell
          title={LABOR_WORK_LOG_MODULE_TITLE}
          description={LABOR_WORK_LOG_MODULE_DESCRIPTION}
        >
    ...
    return (
      ...
      >
        <BillingSectionNav />
        <BillingModuleIntro>{LABOR_WORK_LOG_MODULE_DESCRIPTION}</BillingModuleIntro>
