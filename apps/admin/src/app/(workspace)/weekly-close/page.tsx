...
import { PayrollSourceCallout } from "../../../components/payroll-source-callout";
import { TimeSectionNav } from "../../../components/time-section-nav";
import { WeeklyCloseWorkspace } from "../../../components/weekly-close-workspace";
import {
  WEEKLY_CLOSE_LOCK_HELPER,
  WEEKLY_CLOSE_MODULE_DESCRIPTION,
  WEEKLY_CLOSE_MODULE_TITLE
...
export default async function WeeklyClosePage({ searchParams }: WeeklyClosePageProps) {
  try {
    ...
    if (workspace.blocked) {
      return (
        <AdminShell title={WEEKLY_CLOSE_MODULE_TITLE} description={WEEKLY_CLOSE_MODULE_DESCRIPTION}>
          <TimeSectionNav />
    ...
    return (
      <AdminShell
        title={WEEKLY_CLOSE_MODULE_TITLE}
        description={WEEKLY_CLOSE_MODULE_DESCRIPTION}
        actions={
      ...
      >
        <TimeSectionNav />
        <EmployeesModuleIntro help={WEEKLY_CLOSE_LOCK_HELPER}>
          {WEEKLY_CLOSE_MODULE_DESCRIPTION}
