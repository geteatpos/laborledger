...
import {
  VEHICLES_MODULE_DESCRIPTION,
  VEHICLES_MODULE_TITLE
...
export default async function VehiclesPage({ searchParams }: VehiclesPageProps) {
  try {
    ...
    if (workspace.blocked) {
      return (
        <AdminShell
          title={VEHICLES_MODULE_TITLE}
          description={VEHICLES_MODULE_DESCRIPTION}
        >
          <ReceptionSectionNav />
    ...
    return (
      <AdminShell title={VEHICLES_MODULE_TITLE} description={VEHICLES_MODULE_DESCRIPTION}>
        <ReceptionSectionNav />
