...
import {
  CORRECTIONS_AUDIT_HELPER,
  CORRECTIONS_MODULE_DESCRIPTION,
  CORRECTIONS_MODULE_TITLE
...
export default async function CorrectionsPage({ searchParams }: CorrectionsPageProps) {
  try {
    ...
    if (workspace.blocked) {
      return (
        <AdminShell title={CORRECTIONS_MODULE_TITLE} description={CORRECTIONS_MODULE_DESCRIPTION}>
          <TimeSectionNav />
    ...
    return (
      <AdminShell
        title={CORRECTIONS_MODULE_TITLE}
        description={CORRECTIONS_MODULE_DESCRIPTION}
        actions={
      ...
      >
        <TimeSectionNav />
        <EmployeesModuleIntro help={CORRECTIONS_AUDIT_HELPER}>
          {CORRECTIONS_MODULE_DESCRIPTION}
